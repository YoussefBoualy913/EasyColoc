        ...
        <main class="p-4 sm:p-6 lg:p-8 space-y-8">
                     ...
                     <div
                        ...
                        <div class="flex items-start justify-between mb-3">
                            ...
                            @if($user->pivot->type !== 'owner')
                                class="w-12 h-12 rounded-full bg-gradient-to-br from-sky-400 to-sky-600 flex items-center justify-center text-white font-bold text-lg"
                            @else
                            class="w-12 h-12 rounded-full bg-gradient-to-br from-violet-400 to-violet-600 flex items-center justify-center text-white font-bold text-lg"
                            @endif
                            >
                                 {{$user->initials}}</div>
                            <span
            ...
            <section id="settlements">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <!-- Balances -->
                    <div class="bg-white rounded-2xl border border-slate-100 p-6 shadow-sm">
                        <h3 class="text-sm font-semibold text-slate-500 uppercase tracking-wider mb-4">Soldes
                            individuels</h3>
                        <div class="space-y-3">
                            {{-- <!-- @foreach($balances as $member => $balance) --> --}}
                            <div class="flex items-center justify-between p-3 rounded-xl bg-slate-50">
                                <div class="flex items-center gap-3">
                                    <div
                                        ...
                                        JD</div>
                                    <span class="font-medium text-slate-900">Jean</span>
                                </div>
                                <span class="font-bold text-emerald-600">+42.50 €</span>
                            </div>
                            <div class="flex items-center justify-between p-3 rounded-xl bg-slate-50">
                                <div class="flex items-center gap-3">
                                    <div
                                        ...
                                        ML</div>
                                    <span class="font-medium text-slate-900">Marie</span>
                                </div>
                                <span class="font-bold text-emerald-600">+60.55 €</span>
                            </div>
                            <div class="flex items-center justify-between p-3 rounded-xl bg-slate-50">
                                <div class="flex items-center gap-3">
                                    <div
                                        ...
                                        PB</div>
                                    <span class="font-medium text-slate-900">Pierre</span>
                                </div>
                                <span class="font-bold text-red-500">-26.95 €</span>
                            </div>
                            <div class="flex items-center justify-between p-3 rounded-xl bg-slate-50">
                                <div class="flex items-center gap-3">
                                    <div
                                        ...
                                        SC</div>
                                    <span class="font-medium text-slate-900">Sophie</span>
                                </div>
                                <span class="font-bold text-red-500">-29.46 €</span>
                            </div>
                            {{-- <!-- @endforeach --> --}}
                        </div>
                    </div>
                            ...
                            <div
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <div
                                        ...
                                        PB</div>
                                    <div>
                                        <p class="text-sm font-semibold text-slate-900">Pierre</p>
                                        <p class="text-xs text-slate-500">doit à <strong
                                                class="text-emerald-600">Marie</strong></p>
                                    </div>
                                </div>
                                <div class="flex items-center gap-3">
                                    <span class="font-bold text-slate-900">26.95 €</span>
                                    {{-- <!-- {{ route('settlements.pay', $settlement) }} --> --}}
                            ...
                            <div
                                ...
                                <div class="flex items-center gap-3">
                                    <div
                                        ...
                                        SC</div>
                                    <div>
                                        <p class="text-sm font-semibold text-slate-900">Sophie</p>
                                        <p class="text-xs text-slate-500">doit à <strong
                                                class="text-emerald-600">Jean</strong></p>
                                    </div>
                                </div>
                                <div class="flex items-center gap-3">
                                    <span class="font-bold text-slate-900">29.46 €</span>
                                    <form action="#" method="POST">
                                        <button type="submit"
                                            class="px-3 py-1.5 rounded-lg bg-emerald-100 text-emerald-700 text-xs font-bold hover:bg-emerald-200 transition">
                                            Marquer payé
